...
def recommend_courses():
    try:
        ...
        if not title_name:
            return jsonify({"success": False, "message": "Course title is required"})
        ...
        if not rec_df.empty:
            ...
            return jsonify({"success": False, "message": "No recommendations found for this course"})
    except Exception as e:
        print(f"Error in recommend_courses: {str(e)}")  # Add debugging
